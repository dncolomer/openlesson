...
import {
  ...
  McpHttpClientError,
  pullMcpToolData,
} from "@/lib/openlesson-demo/mcp-http-client";
import { translateMcpResultToEvents } from "@/lib/openlesson-demo/translate-mcp-to-events";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[demo/mcp-simulation] Error:", error);
