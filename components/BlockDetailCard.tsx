...
export function BlockDetailCard({
  ...
  const cardShellClass = `relative overflow-hidden rounded-xl border border-white/15 bg-neutral-950/95 shadow-[0_10px_40px_rgba(0,0,0,0.45)] ${
  ...
  return (
    <div className={cardShellClass} style={cardShellStyle}>
      ...
      <div className="p-3.5 sm:p-4">
        ...
        {forkCallout ? (
          <div className="mt-3.5">{forkCallout}</div>
        ) : showActions ? (
          <div className="mt-4">
