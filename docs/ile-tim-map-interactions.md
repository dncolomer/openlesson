...
Unopened TIM chapters use the explore/map icon (`tim-explore`). Opening (load or focus) switches them to the usual 3×3 blocky glyph.
...
| --- | --- | --- | --- | --- |
| `chapter_complete_expand` | shipped | `upload_ile_chapter_done` | positive | Done → 1–3 adjacent TIM-sourced chapters (explore icon until opened). |
