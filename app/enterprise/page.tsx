      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="order-2 lg:order-1 bg-[#0a0a0a] lg:border-r border-t lg:border-t-0 border-slate-800 lg:h-[calc(100vh-113px)] lg:overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
          <div className="w-full flex flex-col gap-8">
            {/* Hero Section */}
            <div>
              <h2 className="text-2xl font-bold text-white mb-3">Empower Your Sales Team</h2>
              <p className="text-slate-400 leading-relaxed">
                Transform how your organization learns and grows. OpenLesson provides AI-powered training that adapts to each team member while giving leadership complete visibility into progress and performance.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  ...
                  <span>Generic training programs that don&apos;t address specific skill gaps</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-red-400 mt-0.5">✗</span>
                  <span>No visibility into who&apos;s actually learning vs. just completing modules</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-red-400 mt-0.5">✗</span>
                  <span>Expensive external training with inconsistent results</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  ...
                  <span>Personalized learning paths that adapt to each team member&apos;s needs</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-emerald-400 mt-0.5">✓</span>
                  <span>Real-time competency tracking across your entire organization</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-emerald-400 mt-0.5">✓</span>
                  <span>Scalable training that grows with your team at a fraction of the cost</span>
                </li>
              </ul>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    OpenLesson gives you and your organization the power to dive into individual and collective performance analytics. Track progress, identify skill gaps, and measure ROI across teams and departments.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="order-1 lg:order-2 lg:sticky lg:top-[113px] lg:h-[calc(100vh-113px)] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-6 lg:py-4 relative overflow-hidden">
          ...
          <div 
            ...
            style={{ backgroundImage: "url('/sales.jpg')" }}
          />
          ...
          <div className="w-full flex flex-col relative z-10">
            ...
            <div className="flex justify-center mb-3">
              <span className="text-xs font-medium text-white/70 uppercase tracking-wider">{t('enterprise.label')}</span>
            </div>
