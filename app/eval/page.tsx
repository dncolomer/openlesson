      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="order-2 lg:order-1 bg-[#0a0a0a] lg:border-r border-t lg:border-t-0 border-slate-800 lg:h-[calc(100vh-113px)] lg:overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
          <div className="w-full flex flex-col gap-8">
            {/* Hero Section */}
            <div>
              <h2 className="text-2xl font-bold text-white mb-3">Smarter Candidate Evaluation</h2>
              <p className="text-slate-400 leading-relaxed">
                Move beyond resume screening and standardized tests. OpenLesson provides AI-powered competency assessments that reveal true candidate capabilities while generating detailed reports for informed hiring decisions.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  ...
                  <span>Traditional assessments don&apos;t measure real-world problem-solving ability</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-red-400 mt-0.5">✗</span>
                  <span>Inconsistent evaluation criteria across interviewers and teams</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-red-400 mt-0.5">✗</span>
                  <span>Time-consuming manual screening that delays hiring decisions</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  ...
                  <span>AI-driven assessments that adapt to candidate responses in real-time</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-emerald-400 mt-0.5">✓</span>
                  <span>Standardized competency reports for objective comparison</span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <span className="text-emerald-400 mt-0.5">✓</span>
                  <span>Scalable screening that processes hundreds of candidates efficiently</span>
                </li>
              </ul>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    OpenLesson gives you and your organization the power to dive into individual and collective performance analytics. Compare candidates objectively, identify strengths and gaps, and make data-driven hiring decisions.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="order-1 lg:order-2 lg:sticky lg:top-[113px] lg:h-[calc(100vh-113px)] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-6 lg:py-4 relative overflow-hidden">
          ...
          <div className="w-full flex flex-col relative z-10">
            ...
            <div className="flex justify-center mb-4">
              <span className="text-xs text-white/70 uppercase tracking-widest">{t('eval.label')}</span>
            </div>
