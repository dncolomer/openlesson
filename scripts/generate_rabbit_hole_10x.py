...
def main():
    ...
    parser.add_argument("--input", default="scripts/data/rabbit-hole/rabbit-hole-questions-expanded.csv")
    parser.add_argument("--output", default="scripts/data/rabbit-hole/rabbit-hole-questions-10x.csv")
