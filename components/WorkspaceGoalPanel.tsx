...
export function WorkspaceGoalPanel({
  ...
  return (
    <div
      className="rounded-none border border-white bg-black p-4 shadow-[0_8px_28px_rgba(0,0,0,0.45)] sm:p-5"
      data-workspace-goal-panel
      data-goal-surface="black"
    >
      <div className="flex items-start gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-none border border-white/25 bg-white/5 text-white">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {isOwner && !isEditing && plan.workspace_goal ? (
              <button
                ...
                className="shrink-0 rounded-none p-1 text-neutral-500 transition-colors hover:bg-white/10 hover:text-white"
          ...
          {isEditing ? (
            <div className="mt-2 space-y-2">
              <input
                ...
                className="w-full rounded-none border border-white/20 bg-neutral-950 px-3 py-2.5 text-sm font-medium text-white placeholder:text-neutral-600 focus:border-white/50 focus:outline-none"
                autoFocus
              />
              <div className="flex items-center gap-3 text-xs">
                <button
                  ...
                  disabled={saving}
                  className="rounded-none bg-white px-3 py-1.5 font-medium text-black transition-colors hover:bg-neutral-200 disabled:opacity-50"
                >
