...
${buildOrbitUiManifestForWorkspace()}`
  ...
  partnerDescription:
    "Orbit partner integration that streams issue-tracker actions as proof of work to Uncertain Systems.",
