...
export async function GET(req: NextRequest, { params }: RouteProps) {
  ...
  let query = supabase
    ...
    .select("id, workspace_id, block_id, status, requested_duration_seconds, duration_seconds, focus_block_ids, overall_score, created_at, started_at, completed_at, participant_type, post_session, redirect_url, guest_user_id, assigned_user_id, access_mode, public_token, entry_query_params, show_end_session, interaction_kind")
    .eq("workspace_id", id)
