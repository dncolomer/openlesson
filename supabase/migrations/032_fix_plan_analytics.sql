-- ============================================
-- Fix: get_personal_plan_analytics + get_org_plan_analytics
-- Both functions referenced `p2.metadata->>'gapScore'` but the probes table
-- has a direct `gap_score` column (FLOAT), not a `metadata` JSONB.
--
-- Reapplying both functions with the corrected column reference.
-- ============================================
