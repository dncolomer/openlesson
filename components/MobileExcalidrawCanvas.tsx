  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0a]" data-no-swipe="true">
      ...
      <div className="shrink-0 bg-neutral-900 border-t border-neutral-800">
        {/* Submit to Helios — full-width primary action */}
        {onSubmitToHelios && (
          <div className="px-2 pt-2">
            <button
              ...
              className="w-full py-2.5 rounded-lg bg-white/10 border border-white/30 text-white active:bg-white/20 active:border-white/50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm font-medium transition-colors"
            >
