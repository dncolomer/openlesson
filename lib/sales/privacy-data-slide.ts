 ...
 * PoW API + learning model work on anonymized / redacted proof of work —
...
export function buildPrivacyDataSlide(): SalesSlide {
  return {
    ...
    ...labeledHighlights([
      [
        "Privacy-first PoW",
        "Score skill from anonymized, redacted, or synthetic proof of work — not from a dump of your enterprise corpus.",
      ],
      [
        "Keep secrets local",
    ...
    bullets: [
      ...
      "Learning model and marker scores run on skill-relevant structure — not on your full enterprise corpus",
      ...
      "Same verification, optimization, and augmentation loop — privacy-preserving by design",
    ],
  };
}
