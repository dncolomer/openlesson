...
Role:
- TIM is an **interruption world model**. It is not the learning world model (exploration, conversion, GHC, evidence appetite), but it **reads** learning-world and score features when provided.
...
- Higher overall_score / exploration (deeper workspace coverage / demonstrated knowledge)
- Higher conversion_score toward conversion_goal
