...
Return should_interrupt: false unless a specific, contextual intervention would improve overall_score, conversion_score, GHC signal quality, or fill evidence_appetite.want_more right now.`),
  ];
}
