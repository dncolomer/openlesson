  ...
  return [
    ...
    },
    {
      ...
      bullets: [
        ...
        "With Strangeworks and TheWiser.org, that pedagogy became production educational material for quantum programs — not demos, curriculum.",
      ],
    },
    {
      layout: "statement",
      ...
      bullets: [
        "Format: frontier domains, live practice, and visible reasoning — not leaderboard scores or overnight CRUD clones alone.",
